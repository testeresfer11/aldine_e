<header class="header-top">
  <div class="container-cstm">
    <nav class="navbar navbar-expand-lg flex-wrap justify-content-between p-0 align-items-center">
      <div class="header-logo">
        <a class="navbar-brand f-40 text-black semi-bold" href="{{ url('/') }}"><img src="{{ asset('images/logo.svg') }}"></a>
      </div>
      <a href="#" class="nav-cta hide-mb">Download on the App Store for Free</a>
      <a href="#" class="nav-cta mobile">Download for Free</a>
